...
<html lang='en'>
    ...
    <body>
        ...
        <div class="container">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    <?php
                        ...
                        $sql = "SELECT * FROM round1_result r LEFT JOIN team t ON r.team_id = t.team_id ORDER BY status DESC, wrong ASC";
            ...
            <a href="round2_resultANDteam_result_dumy.php" ><button type="button" class="btn btn-primary btn-lg btn-block">Start Round 2</button></a>
        </div>
        ...
        <script>
            ...
            $(document).ready(function(){
                $(".btn-success").click(function(){
                    var ID = $(this).val();
                    $.ajax({
                        url:'db/db_round1_result_display.php',
                        type: "GET",
