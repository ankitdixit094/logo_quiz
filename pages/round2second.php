            ...
            <div class="dilogbox-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-7 alert alert-warning disc">
                            <h3 style="font-weight: 900;" >Logo Description</h3>
                    ...
                    ?>
                    <form method="post" action="db/db_round2_result_update.php" class="">
                        <div class="form-group">
                            <button type="submit" class="btn btn-success btn-lg pull-left" style="width: 40%;" name="submit" value="correct"><i class="fa fa-check-square-o fa-2x"></i></button>
