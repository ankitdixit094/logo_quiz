        ...
        <div class="alert alert-info container dilogbox" style="width: 90%;">
            ...
            <div class="dilogbox-body">
                <div class="container-fluid">
                    ...
                    ?>
                    <form method="post" action="db/db_round3_result_update.php" class="">
                        <div class="form-group">
                            <center>
                                <?php if($_POST['submit'] == $_SESSION['logoNameReal']):?>
                                    <button type="submit" class="btn btn-success btn-lg" style="width: 40%;" name="submit" value="correct"><i class="fa fa-check-square-o fa-2x"></i></button>
                                <?php else:?>
                                    <button type="submit" class="btn btn-danger btn-lg" style="width: 40%;" name="submit" value="wrong"><i class="fa fa-times fa-2x"></i></button>
                                <?php endif;?>
                            </center>
                        </div>
                    </form>
